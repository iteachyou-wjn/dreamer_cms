...
public class VariableController extends BaseController {
	...
	@RequestMapping({"","/list"})
	@RequiresPermissions("system:variable:page")
	...
	@RequiresPermissions("system:variable:toadd")
	...
	@RequestMapping("/add")
	@RequiresPermissions("system:variable:add")
	...
	@RequiresPermissions("system:variable:detail")
	...
	@RequiresPermissions("system:variable:toedit")
	...
	@RequiresPermissions("system:variable:update")
	...
	@RequiresPermissions("system:variable:delete")
