...
public class JedisShiroCache<K, V> implements Cache<K, V> {
	 ...
	 */
	private static final String REDIS_SHIRO_CACHE = "CMS-USER:";
	/**
	...
	public V get(K key) throws CacheException {
		...
		try {
			...
			LoggerUtils.getExceptionLogger().error("get value by cache throw exception", e);
		}
	...
	public V put(K key, V value) throws CacheException {
		...
		try {
			...
			LoggerUtils.getExceptionLogger().error("put cache throw exception", e);
		}
		return previos;
	}
	...
	public V remove(K key) throws CacheException {
		...
		try {
			...
			LoggerUtils.getExceptionLogger().error("remove cache  throw exception", e);
		}
		return previos;
	}
