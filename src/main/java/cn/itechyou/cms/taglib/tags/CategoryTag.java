...
public class CategoryTag implements IParse {
	...
	public String parse(String html,String typeid) {
		...
		for (String string : all) {
			...
			String imagePath = "";
			if(StringUtils.isNotBlank(temp.getImagePath())) {
				imagePath = temp.getImagePath();
				imagePath = imagePath.replace("\\", "/");
			}
			String typeCode = StringUtils.isBlank(temp.getCode()) ? "" : temp.getCode();
			String visitUrl = StringUtils.isBlank(temp.getVisitUrl()) ? PinyinUtils.toPinyin(temp.getCnname()) : temp.getVisitUrl();
			...
			if(entity.containsKey("field")) {
				...
				if(FieldEnum.FIELD_TYPEID.getField().equalsIgnoreCase(name)) {
					...
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getCnname()) ? "" : temp.getCnname());
				}else if (FieldEnum.FIELD_TYPENAMEEN.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getEnname()) ? "" : temp.getEnname());
					...
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getCatSeq()) ? "" : temp.getCatSeq());
					...
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getDescription()) ? "" : temp.getDescription());
				}else if (FieldEnum.FIELD_LINKTARGET.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getLinkTarget()) ? "" : temp.getLinkTarget());
				}else if (FieldEnum.FIELD_PAGESIZE.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getPageSize()) ? Constant.PAGE_SIZE_VALUE + "" : temp.getPageSize().toString());
					...
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getLinkUrl()) ? "" : temp.getLinkUrl());
				}else if (FieldEnum.FIELD_EDITOR.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getDefaultEditor()) ? "" : temp.getDefaultEditor());
				}else if (FieldEnum.FIELD_MARKDOWN.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getMdContent()) ? "" : temp.getMdContent());
				}else if (FieldEnum.FIELD_UEHTML.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getHtmlContent()) ? "" : temp.getHtmlContent());
				}else if (FieldEnum.FIELD_PARENTNAME.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getParentName()) ? "" : temp.getParentName());
				}else if (FieldEnum.FIELD_ISSHOW.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getIsShow()) ? "" : temp.getIsShow().toString());
				}else if (FieldEnum.FIELD_LEVEL.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getLevel()) ? "" : temp.getLevel());
				}else if (FieldEnum.FIELD_SORT.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getSort()) ? "" : temp.getSort().toString());
				}else if (FieldEnum.FIELD_TCREATEBY.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getCreateBy()) ? "" : temp.getCreateBy());
				}else if (FieldEnum.FIELD_TCREATETIME.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getCreateTime()) ? "" : temp.getCreateTime().toString());
				}else if (FieldEnum.FIELD_TUPDATEBY.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getUpdateBy()) ? "" : temp.getUpdateBy());
				}else if (FieldEnum.FIELD_TUPDATETIME.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getUpdateTime()) ? "" : temp.getUpdateTime().toString());
					...
					if(temp.getCatModel() == 1) {
						...
						newHtml = newHtml.replace(string, "/list-" + typeCode + visitUrl + "/1/"
								+ (StringUtils.isBlank(temp.getPageSize()) ? Constant.PAGE_SIZE_VALUE + "" : temp.getPageSize().toString()));
					}else if(temp.getCatModel() == 3) {
						newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getLinkUrl()) ? "" : temp.getLinkUrl());
					}
				}else if (FieldEnum.FIELD_EXT01.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getExt01()) ? "" : temp.getExt01());
				}else if (FieldEnum.FIELD_EXT02.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getExt02()) ? "" : temp.getExt02());
				}else if (FieldEnum.FIELD_EXT03.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getExt03()) ? "" : temp.getExt03());
				}else if (FieldEnum.FIELD_EXT04.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getExt04()) ? "" : temp.getExt04());
				}else if (FieldEnum.FIELD_EXT05.getField().equalsIgnoreCase(name)) {
					newHtml = newHtml.replace(string, StringUtils.isBlank(temp.getExt05()) ? "" : temp.getExt05());
				}
			}
		}
		return newHtml;
